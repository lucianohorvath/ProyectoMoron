 ...
 * @author Alfa02
 */
public class DescontarStockMp extends javax.swing.JFrame {

    /**
     * Creates new form AgregarStockMp
     */
    public DescontarStockMp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Descontar Stock de Materias Primas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DescontarStockMp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DescontarStockMp().setVisible(true);
            }
        });
    }
